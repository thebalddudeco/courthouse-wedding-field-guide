...
const required = ['index.html', 'roam.css', 'fonts/alfa-slab-one.woff2', 'fonts/inter-latin.woff2', 'templates.js', 'app.js', 'samples.html', 'samples.css', 'samples.js', 'sw.js', 'manifest.webmanifest', 'icon-180.png', 'icon-192.png', 'icon-512.png'];
