...
const required = ['index.html', 'style.css', 'templates.js', 'app.js', 'samples.html', 'samples.css', 'samples.js', 'sw.js', 'manifest.webmanifest', 'icon-180.png', 'icon-192.png', 'icon-512.png'];
