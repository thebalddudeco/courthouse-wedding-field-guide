const CACHE='shotflow-v5';
const ASSETS=['./','./index.html','./style.css','./templates.js','./app.js','./samples.html','./samples.css','./samples.js','./manifest.webmanifest','./icon.svg','./icon-180.png','./icon-192.png','./icon-512.png'];
